                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-6">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" id="zip-code" v-model="zipcode">
                            </div>
                        </div>
                        <div class="field">
...
export default {
  ...
  mounted() {
    document.title = "Checkout | Farm Fresh"

    this.cart = this.$store.state.cart

    if (this.cartTotalLength > 0) {
        this.stripe = Stripe('pk_test_51J4rESSDmIUt8wOpCvgnJvRS1wwawk5iGFw7eraicART0qdTUqj0MKqahNAM3ZINfWHdYp7Q2iHvWijw0t621Oc2009cKQA7HP')
